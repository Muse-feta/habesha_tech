            ...
            <div className="img-box1">
              ...
              <div className="about-info">
                ...
                <p className="box-text">
                  Reliable Pharmaceutical <br />Partner.
                </p>
                ...
                <a href="tel:+16356478965" className="box-link"
                  ><i className="fa-solid fa-phone"></i> +163 564 78965</a>
              </div>
            </div>
          </div>
              ...
              <div className="title-area mb-32">
                <span className="sub-title"
                  ><img
                    ...
                    alt="shape"
                  />About Us Company</span>
                <h2 className="sec-title">Affordable Pharmaceutical Supply Solutions</h2>
                <p className="sec-text">
                  At Mamigas Pharmaceuticals, our purpose is to enhance community health by supplying safe, affordable, and high-quality medicines to hospitals and pharmaceutical distributors. 
                </p>
              </div>
              <div className="mb-30 mt-n1">
                <div className="checklist style2 list-two-column">
                  <ul>
                    ...
                    <li><i className="fas fa-heart-pulse"></i> Innovation</li>
                    <li>
                      <i className="fas fa-heart-pulse"></i> Commitment
                    </li>
                    <li><i className="fas fa-heart-pulse"></i> Collaboration</li>
                    <li><i className="fas fa-heart-pulse"></i> Quality</li>
                  </ul>
                </div>
              </div>
              <div><a href="about.html" className="th-btn">More About Us</a></div>
            </div>
          </div>
        </div>
      </div>
