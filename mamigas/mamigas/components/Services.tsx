      ...
      <div className="container">
        ...
        <div className="row gy-4 justify-content-center">
          ...
          <div className="col-xl-3 col-lg-4 col-sm-6">
            <div
              className="service-card"
              data-bg-src="assets/img/service/service_card_2.jpg"
            >
              <div className="box-shape">
                <img src="assets/img/bg/service_card_bg.png" alt="Service" />
              </div>
              ...
              <h3 className="box-title">
                <a href="service-details.html">Specialized Product Range</a>
              </h3>
              <p className="box-text">Product Variety</p>
              <a
                href="service-details.html"
                className="th-btn btn-sm style2 theme-color"
                >Read More</a>
          ...
          <div className="col-xl-3 col-lg-4 col-sm-6">
            <div
              className="service-card"
              data-bg-src="assets/img/service/service_card_3.jpg"
            >
              <div className="box-shape">
                <img src="assets/img/bg/service_card_bg.png" alt="Service" />
              </div>
              ...
              <h3 className="box-title">
                <a href="service-details.html">Efficient Logistics Network</a>
              </h3>
              <p className="box-text">Logistics Efficiency</p>
              <a
                href="service-details.html"
                className="th-btn btn-sm style2 theme-color"
                >Read More</a>
          ...
          <div className="col-xl-3 col-lg-4 col-sm-6">
            <div
              className="service-card"
              data-bg-src="assets/img/service/service_card_4.jpg"
            >
              <div className="box-shape">
                <img src="assets/img/bg/service_card_bg.png" alt="Service" />
              </div>
              ...
              <h3 className="box-title">
                <a href="service-details.html">Dedicated Customer Support</a>
              </h3>
